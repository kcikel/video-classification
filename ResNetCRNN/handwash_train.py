...
for epoch in range(120,epochs):
    ...
    np.save('./handwash_training_losses2.npy', A)
    np.save('./handwash_training_scores2.npy', B)
    np.save('./handwash_test_loss.npy', C)
    np.save('./handwash_test_score.npy', D)
