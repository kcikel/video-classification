...
save_model_path = "./handwash_otra_ckpt/"
...
for epoch in range(epochs):
    ...
    np.save('./handwash_training_losses_otra2.npy', A)
    np.save('./handwash_training_scores_otra2.npy', B)
    np.save('./handwash_test_loss_otra2.npy', C)
    np.save('./handwash_test_score_otra2.npy', D)
...
plt.ylabel('accuracy')
plt.legend(['train', 'test'], loc="upper left")
title = "./fig_handwash_ResNetCRNN_otra.png"
